...
const TicketChat = ({ ticketId }: Props) => {
  ...
  return (
    <div style={chatContainer}>
      <h4 style={{ borderBottom: '1px solid #ddd', paddingBottom: '10px' }}>Conversación de Soporte</h4>
      ...
      <div style={messageList}>
        {messages.map((msg: any) => (
          <div key={msg.id} style={{
            ...
            backgroundColor: msg.sender?.role === 'ADMIN' ? '#f1f0f0' : '#dcf8c6'
          }}>
      ...
      <form onSubmit={handleSend} style={{ display: 'flex', gap: '10px' }}>
        ...
        />
        <button type="submit" style={sendButton}>Enviar</button>
      </form>
    </div>
  );
};
