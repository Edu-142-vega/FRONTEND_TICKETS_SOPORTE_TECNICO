...
const CrearTicket = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Enviamos solo lo que el servidor permite (según tu backend actual)
      const payload = {
  ...
  // Color de barra lateral del selector de prioridad
      ...
      <div className="card border-0 shadow-lg p-4 p-md-5" style={cardStyle}>
        <div className="text-center mb-5">
          ...
          <p className="text-muted">
            Completa los detalles para que nuestro equipo técnico te ayude.
          </p>
        </div>
            ...
            <div className="col-md-6 mb-4">
              ...
              >
                ...
                <optgroup label="Infraestructura">
                  ...
                  <option value="3">Periféricos (Impresoras, Scanners)</option>
